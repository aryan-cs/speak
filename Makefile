...
local: check setup
	...
	if [ -d "$$APP_PATH" ]; then \
		...
		ditto "$$APP_PATH" "$$HOME/Downloads/Speak.app"; \
		xattr -cr "$$HOME/Downloads/Speak.app"; \
		echo ""; \
		echo "Build complete! App saved to: ~/Downloads/Speak.app"; \
		echo "Run with: open ~/Downloads/Speak.app"; \
		echo ""; \
