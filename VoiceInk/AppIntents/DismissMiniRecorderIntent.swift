...
struct DismissMiniRecorderIntent: AppIntent {
    ...
    static var description = IntentDescription("Dismiss the Speak mini recorder and cancel any active recording.")
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        let dialog = IntentDialog(stringLiteral: "Speak recorder dismissed")
