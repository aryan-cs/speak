...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: AppConstants.logSubsystem, category: "LogExporter")
    private let subsystem = AppConstants.logSubsystem
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Speak Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Speak_Logs_\(timestamp).log"
