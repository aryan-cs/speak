        ...
        ScrollView {
            VStack(spacing: 32) {
                ...
                CompactHeroSection(
                    ...
                    description: "Speak requires the following permissions to function properly"
                )
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use Speak anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Speak to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Speak to paste transcribed text directly at your cursor position",
                        ...
                        infoTipMessage: "Speak uses Accessibility permissions to paste the transcribed text directly into other applications at your cursor's position. This allows for a seamless dictation experience across your Mac."
                    )
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Speak to understand context from your screen for transcript Enhancement",
                        ...
                        infoTipMessage: "Speak captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
